...
<p align="center">
  ...
  <a href="https://github.com/LXGIC-Studios/ai-codemod/actions">
...
[![License: MIT](https://img.shields.io/npm/l/ai-codemod.svg?style=for-the-badge&logo=mit&color=blue)](https://github.com/LXGIC-Studios/ai-codemod/blob/main/LICENSE)
...
```bash
git clone https://github.com/LXGIC-Studios/ai-codemod.git
cd ai-codemod
npm install
npm run dev
```
